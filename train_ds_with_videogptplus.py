...
class AllArguments:
    ...
    ############ DataArguments ###### have to change here
    ...
    val_dataset:str=field(default="ReasonSeg|val")
    
    num_frames_for_sam:int=field(default=1)
    ...
    if not args.eval_only:
        ...
        if "custom_video" in args.dataset.split("||"):
            ...
            train_dataset = CustomVideoDataset(
                base_video_dataset_dir=args.video_dataset_dir,  # Use video_dataset_dir instead of hardcoded path
                enc_preprocessor=enc_preprocessor,
                sam_preprocessor=sam_preprocessor,
                conversation_generator=conversation_generator,
                vision_tower=args.vision_tower,
                image_vision_tower=args.image_vision_tower,
                image_size=224,
